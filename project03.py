...
responses = {
    "hello":["Hii there!","Hello! How can i help you?","Hey!What's up?"],
    "how are you":["I'm doing great!","I'm fine, thanks for asking!","All good, thanks for asking!"],
    "your name":["My name is PyBot","You can call me PyBot!","I'm PyBot, your assistant."],
    "bye":["Goodbye","See you later!","Bye!Hve a nice day!"]
}
